...
local function DebugScriptAt(o, fl)
    ...
    local function printFunctionHierarchy(entry, out, indent)
        ...
        if entry.info then
			table.insert(out, indent .. "  Params: " .. (entry.info.numparams or 0) .. ", Vararg: " .. tostring(entry.info.is_vararg) .. ", Lines: " .. (entry.info.linedefined or 0) .. "-" .. ((entry.info.lastlinedefined ~= 0 and entry.info.lastlinedefined) or fl or 0))
        end
