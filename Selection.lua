...
local function AfterInitialization()
    for _, v in ipairs(Dex:GetDescendants()) do
        if v:IsA("Frame") and v.Name ~= "Other" and v.Name ~= "SettingTemplate" and v.Name ~= "MapSettings" and v.Name ~= "SettingList" or (v.Name ~= "MainWindow" and v.Parent.Name ~= "ModelViewer")  then
