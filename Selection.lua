...
local function createSetting(p1, p2, p3, p4)
	...
	A.Position = UDim2_new(0, 0, 0, (#SettingList:GetChildren() * (p4 and 20 or 60)))
	A.SName.Text = p1
	local B = A.Change
	local function C(p4)
...
createSetting("CLICK TO SELECT PART", "ClickSelect", Settings.ClickSelect)
...
createSetting("SHOW BOUNDING BOXES", "BBoxes", Settings.BBoxes)
...
createSetting("SHOW ACTIVE ANIMATIONS", "AAnims", Settings.AAnims)
